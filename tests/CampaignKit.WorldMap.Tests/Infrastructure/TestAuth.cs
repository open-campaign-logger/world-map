...
{
	public class TestAuth : AuthenticationHandler<TestAuthenticationOptions>
	{
		public TestAuth(IOptionsMonitor<TestAuthenticationOptions> options, ILoggerFactory logger,
	...
	public static class TestAuthenticationExtensions
	{
		...
		{
			return builder.AddScheme<TestAuthenticationOptions, TestAuth>("Test Scheme", "Test Auth", configureOptions);
		}
	}
