...
namespace CampaignKit.WorldMap.Data
{
    ...
    public interface IMapRepository
    {
        ...
        Task<bool> CanEdit(string id, ClaimsPrincipal user);
        ...
        /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
        Task<bool> CanView(string id, ClaimsPrincipal user, string shareKey);
        ...
        Task<string> Create(Map map, Stream stream, ClaimsPrincipal user);

        /// <summary>Deletes the specified map and all child entities.</summary>
        /// <param name="id">The map identifier.</param>
        /// <param name="user">The authenticated user.</param>
        /// <returns><c>true</c> if successful, <c>false</c> otherwise.</returns>
        Task<bool> Delete(string id, ClaimsPrincipal user);
        ...
        Task<Map> Find(string id, ClaimsPrincipal user, string shareKey);
