...
{
    /// <summary>
    ///     Interface IWorldBasePathService
    /// </summary>
    public interface IWorldBasePathService
    {
    ...
    /// <inheritdoc />
    /// <summary>
    ///     Class DefaultWorldBasePathService.
    /// </summary>
    public class DefaultWorldBasePathService : IWorldBasePathService
    {
        #region Public Constructors

        /// <summary>
        ///     Initializes a new instance of the <see cref="DefaultWorldBasePathService" /> class.
        /// </summary>
        /// <param name="env">The env.</param>
        public DefaultWorldBasePathService(IHostingEnvironment env)
        {
